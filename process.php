...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    echo "<h3 style='color: green;'>successfully Form Submitted. Token used (ifneeded) and generated Receipt.</h3>";
}
?>
...
<body>
    <div class="receipt-container">
        ...
        <h1>Book Borrowing Receipt: </h1>
            ...
            <p><strong>BOOK TITTLE:</strong> <?php echo $bookTitle; ?></p>
